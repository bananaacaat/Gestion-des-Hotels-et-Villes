...
public class TestHotel {
	...
	public static IDaoRemote<Hotel> lookUpEmployeRemote() throws NamingException {
		...
		return (IDaoRemote<Hotel>) context.lookup("ejb:ISICEJBEAR/ISICEJBServer/yassine!dao.IDaoRemote");
	...
	public static void main(String[] args) {
		...
		try {
			...
			Ville Casablanca = new Ville("Casablanca");
			dao.create(new Hotel("Sango","GG","0656444656", Casablanca));
			Ville Marrakech = new Ville("Marrakech");
			dao.create(new Hotel("Saada","Bennani","0656565656", Marrakech));
